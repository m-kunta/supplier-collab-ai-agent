...
class PipelineIntegrationTests(unittest.TestCase):
    ...
    def test_summarize_request_resolves_vendor_name_and_loads_vendor_data(self):
        ...
        self.assertIsNone(summary["inventory_insights"])
        self.assertIsNone(summary["forecast_insights"])
        self.assertIsNone(summary["asn_insights"])
        self.assertIsNone(summary["chargeback_insights"])
        self.assertIsNone(summary["trade_fund_insights"])
