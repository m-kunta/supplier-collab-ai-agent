...
**Project:** `supplier-collab-ai`
**Repository:** `m-kunta/supplier-collab-ai`
...
|---|---|---|
| **Repo name** | `supplier-collab-ai` | Broad framing allows agent to evolve beyond briefings |
...
|---|---|---|
| **Repo** | `m-kunta/replenishment-triage-ai` | `m-kunta/supplier-collab-ai` |
